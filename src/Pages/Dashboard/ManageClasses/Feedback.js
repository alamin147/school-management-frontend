...
const Feedback = () => {
    ...
    const handleFeedback = (data) => {
        setLoading(true)
        // const feedback = data;
        fetch(`https://assignment-12-server-iota-two.vercel.app/feedback?id=${id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <>
            <div className="hero bg-base-200 mt-20 mb-24 py-5">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        <h1 className="text-5xl font-bold inline">Send feedback</h1>
                        <div>
            ...
            <form className='mt-6 text-center pb-6' onSubmit={handleSubmit(handleFeedback)} >
